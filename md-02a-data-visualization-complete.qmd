...
1.  Use the `ggplot()` function and assign `gapminder_2007` to the data argument and create a scatterplot using the `geom_point()`function with the following aesthetic mappings:
